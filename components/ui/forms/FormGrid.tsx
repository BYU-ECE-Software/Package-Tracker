...
// Generic 2-column form grid wrapper, extracted from FormModal so the same
// layout primitive can be reused inside step/tab modal content (or anywhere
// a form-grid look is needed). Uses CSS subgrid via auto-rows-[auto_auto_auto]
